--
-- Base de datos: `dungeon_cards`
--

CREATE DATABASE IF NOT EXISTS `dungeon_cards`;
USE `dungeon_cards`;
...
--
-- Estrutura da táboa `mazo`
--

CREATE TABLE IF NOT EXISTS `mazo`(
	`cod_personaxe` tinyint NOT NULL,
	`cod_inimigo` tinyint NOT NULL,
	`cod_obxecto` tinyint NOT NULL,
	PRIMARY KEY (`cod_personaxe`, `cod_inimigo`, `cod_obxecto`),
	FOREIGN KEY (`cod_personaxe`) REFERENCES `personaxe` (`codigo`),
	FOREIGN KEY (`cod_inimigo`) REFERENCES `inimigo` (`codigo`),
	FOREIGN KEY (`cod_obxecto`) REFERENCES `obxecto` (`codigo`)
